...
var ProductsService = function () {
    ...
    var ProductsService = _classThis = /** @class */ (function () {
        ...
        ProductsService_1.prototype.findAll = function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                var where, _c, data, total;
                var category = _b.category, search = _b.search, page = _b.page, limit = _b.limit;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, { data: data, total: total, page: page, limit: limit, pages: Math.ceil(total / limit) }];
                    }
                });
            });
        };
        ...
        ProductsService_1.prototype.create = function (dto, userId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.designer.findUnique({ where: { userId: userId } })];
                        case 1:
                            designer = _a.sent();
                            if (!designer)
                                throw new common_1.ForbiddenException('Designer profile required');
                            ...
                            return [2 /*return*/, this.prisma.product.create({
                                    data: __assign(__assign({}, dto), { designerId: designer.id, status: 'PENDING_APPROVAL', sku: "SKU-".concat(Date.now()) }),
                                })];
                    }
                });
            });
        };
        ProductsService_1.prototype.approve = function (id, adminId) {
            return __awaiter(this, void 0, void 0, function () {
                var product;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.product.findUnique({ where: { id: id } })];
                        case 1:
                            product = _a.sent();
                            if (!product)
                                throw new common_1.NotFoundException('Product not found');
