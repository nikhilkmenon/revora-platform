...
var PaymentsController = function () {
    ...
    var PaymentsController = _classThis = /** @class */ (function () {
        ...
        PaymentsController_1.prototype.createOrder = function (dto, userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.paymentsService.createOrder(dto, userId)];
                });
            });
        };
        // ── Razorpay webhook ─────────────────────────────────────────────────
        // Must be raw body to verify HMAC signature
        PaymentsController_1.prototype.handleWebhook = function (req, signature) {
            return __awaiter(this, void 0, void 0, function () {
                var rawBody;
                var _a;
                return __generator(this, function (_b) {
                    rawBody = ((_a = req.rawBody) === null || _a === void 0 ? void 0 : _a.toString()) || JSON.stringify(req.body);
                    return [2 /*return*/, this.paymentsService.handleWebhook(rawBody, signature)];
                });
            });
        };
    ...
    (function () {
        ...
        _createOrder_decorators = [(0, common_1.Post)('create-order'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
