...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        // ── Log in ──────────────────────────────────────────────────────────
        AuthController_1.prototype.login = function (dto, res, req) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.login(dto, req.ip, req.headers['user-agent'])];
                        case 1:
                            result = _a.sent();
                            ...
                            return [2 /*return*/, { accessToken: result.accessToken, user: result.user }];
                    }
                });
            });
        };
        ...
        AuthController_1.prototype.refresh = function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            oldToken = (_a = req.cookies) === null || _a === void 0 ? void 0 : _a.refresh_token;
                            return [4 /*yield*/, this.authService.refresh(oldToken)];
                        case 1:
                            result = _b.sent();
                            res.cookie('refresh_token', result.refreshToken, {
                                httpOnly: true,
                            ...
                            return [2 /*return*/, { accessToken: result.accessToken }];
                    }
                });
            });
        };
        // ── Logout ───────────────────────────────────────────────────────────
        AuthController_1.prototype.logout = function (userId, res) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.logout(userId)];
                        case 1:
                            _a.sent();
                            res.clearCookie('refresh_token', { path: '/api/v1/auth/refresh' });
                            return [2 /*return*/, { message: 'Logged out' }];
                    }
                });
            });
        };
        ...
        AuthController_1.prototype.googleCallback = function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.googleLogin(req.user)];
                        case 1:
                            result = _a.sent();
                            res.cookie('refresh_token', result.refreshToken, {
                                httpOnly: true,
                            ...
                            // Redirect frontend with access token in query (short-lived)
                            res.redirect("".concat(process.env.FRONTEND_URL, "/auth/callback?token=").concat(result.accessToken));
                            return [2 /*return*/];
                    }
                });
            });
    ...
    (function () {
        ...
        _signup_decorators = [(0, common_1.Post)('signup'), (0, throttler_1.Throttle)({ short: { limit: 3, ttl: 60000 } })];
        _login_decorators = [(0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, throttler_1.Throttle)({ short: { limit: 5, ttl: 60000 } })];
        _refresh_decorators = [(0, common_1.Post)('refresh'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _logout_decorators = [(0, common_1.Post)('logout'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
