    ...
    <div className="bg-[#fef7ff] text-[#1d1a24] min-h-screen flex items-center justify-center relative overflow-hidden antialiased py-12">
      ...
      <div className="relative z-10 w-full max-w-[480px] px-5 md:px-0">
        ...
        <div className="glass-card rounded-2xl p-8 md:p-10 flex flex-col gap-6">
          ...
          {/* Social */}
            <button type="button" onClick={() => window.location.href = `${env.apiUrl}/auth/google`} className="w-full h-12 flex items-center justify-center border border-[#ccc3d7] rounded-2xl hover:border-[#5300b7] hover:bg-[#f9f1ff] transition-all bg-white gap-3">
              ...
              <span className="text-sm font-semibold text-[#1d1a24]">Continue with Google</span>
            </button>
