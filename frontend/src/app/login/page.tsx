...
type Role = "BUYER" | "DESIGNER" | "ADMIN";
...
export default function AuthPage() {
  ...
  const ROLES: Role[] = ["BUYER", "DESIGNER", "ADMIN"];
    ...
    <div className="bg-[#fef7ff] text-[#1d1a24] min-h-screen flex items-center justify-center relative overflow-hidden antialiased py-12">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          src="https://lh3.googleusercontent.com/aida-public/AB6AXuAcHJzaML1RGbww0nHduJH5FoE3FKhih4esr_8rcRxk5AzphbdUI80HvJhfRkqscvh_L9scYopvaQeBdnEUXikplC_eVzOdkli4o3FdoGGurJXCw86Wrr1rIXMKoyQGgDQvKEplCuB3Wt3ZM0dif8X5YTY6kyIG6jHmG8oUQk92u-U-h448faMwn4F94IrX7VTILD9S8OpQPiTEOZc47Yuz-pC0ZZk860b4wLVaKogC5oAkdDSxP3VfVPGR3Pn7YDC6eU2_MMxxjMY"
        />
      ...
      <div className="relative z-10 w-full max-w-[480px] px-5 md:px-0">
        ...
        <div className="glass-card rounded-2xl p-8 md:p-10 flex flex-col gap-6">
          ...
          <div className="flex gap-4">
            <button type="button" className="flex-1 h-12 flex items-center justify-center border border-[#ccc3d7] rounded-2xl hover:border-[#5300b7] hover:bg-[#f9f1ff] transition-all bg-white">
