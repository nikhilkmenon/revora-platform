...
export const metadata: Metadata = {
  title: "REVORA — Luxury Sustainable Marketplace",
  description: "The definitive platform for sustainable luxury digital assets, designer collections, and raw textile sourcing.",
};
